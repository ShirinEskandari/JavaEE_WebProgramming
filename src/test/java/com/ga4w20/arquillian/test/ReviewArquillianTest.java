...
/**
 * Arquillian test for ReviewJpaController
 *
 * @author Finley
 */
@RunWith(Arquillian.class)
public class ReviewArquillianTest {
    ...
    /**
     * This method tests if it returns a list of three Reviews
     */
    @Test
    public void testGetHorizontalAd() {
        List<Review> topThree = this.reviewJpaController.findTopThreeByBook("978-0756404741");
