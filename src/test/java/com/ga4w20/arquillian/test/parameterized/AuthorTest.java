...
/**
 * Parameterized testing for authors
 * @author Grant
 */
@RunWith(Arquillian.class)
public class AuthorTest {

    private final static Logger LOG = LoggerFactory.getLogger(AuthorTest.class);
    ...
    public ParameterRule rule = new ParameterRule("dynamic",
            new Author(100, "Grant", "Manzano"),
            new Author(101, "The", "QuarantineMen"),
            new Author(102, "HydrationIs", "Key"),
            new Author(103, "Music", "Theatre"),
            new Author(104, "James", "Dylan"),
            new Author(105, "Lillllllly", "Anh"),
            new Author(106, "Bose", "Speakers"),
            new Author(107, "Random", "Name")
    );

    private Author dynamic;
    ...
    /**
     * Test method that gets the full name of an author.
     */
    @Test
    public void testGetAuthor(){
        LOG.debug("testGetAuthor");
        
        author = dynamic;
        authorController.create(author);
        
        String authorFullName = authorController.getAuthorName(author.getAuthorID());
        assertThat(authorFullName).isEqualTo(author.getFName() + " " + author.getLName());
    }
