...
public class TaxArquillianTest {

    private final static Logger LOG = LoggerFactory.getLogger(TaxArquillianTest.class);
    ...
    @Inject
    private TaxJpaController taxController;
    ...
    /**
     * This method tests getTaxes(String province) to reassure a value is being returned
     * and that it is the proper object
     */
    @Test
    public void testGetTaxes(){
        Tax taxesForQc = this.taxController.getTaxes("QC");
        Tax taxFromDb = this.taxController.findTax(taxesForQc.getTaxID());
        
        assertThat(taxesForQc).isEqualTo(taxFromDb);
    }
